...
$update = "update Review set netID='$netid',DiningHall='$DH',foodName='$item',rating='$rating',comments='$review' where netID='$oldNetid' and DiningHall='$oldDH' and foodName='$oldItem'";
